...
export const RHBarChart: React.FC<Props> = ({ data, Id, label, isLocalLabel, backgroundColor, borderColor, borderWidth,
    stack, childrenBackgroundColor, childrenBorderColor, childrenBorderWidth, childrenStack, onSelectId, min, max, indexAxis,
